...
#define ALIGN_DOWN2(num) ALIGN_DOWN(num, 2)
#define ALIGN_DOWN16(num) ALIGN_DOWN(num, 16)
#define ALIGN_DOWN128(num) ALIGN_DOWN(num, 128)
...
public:
    ...
    */
    ...
    static int WriteImageFile(ImageData& image, std::string fileName);
};
